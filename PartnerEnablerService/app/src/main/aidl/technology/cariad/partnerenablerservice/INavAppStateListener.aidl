...
/**
 * Navigation Application State changes service callback interface
 */
oneway interface INavAppStateListener {
    /**
     * Binder callback for changes to the NavigationApplicationState
     * @hide
    */
    void onNavAppStateChanged(in int appState);
}