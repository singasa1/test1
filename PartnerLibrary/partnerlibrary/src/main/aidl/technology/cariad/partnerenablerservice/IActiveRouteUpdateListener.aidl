...
/**
 * Active Route change service callback interface
 */
oneway interface IActiveRouteUpdateListener {
    /**
     * Binder callback for changes to the ActiveRoute
     * @hide
    */
    void onActiveRouteChange(in String activeRoute);
}