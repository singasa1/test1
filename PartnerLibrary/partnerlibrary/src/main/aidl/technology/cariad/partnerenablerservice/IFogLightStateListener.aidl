...
/**
 * Exterior Fog lights state change service callback interface
 */
oneway interface IFogLightStateListener {
    /**
     * Binder callback for changes to the FogLightsState
     * @hide
    */
    void onFogLightsChanged(in int fogLightState);
}